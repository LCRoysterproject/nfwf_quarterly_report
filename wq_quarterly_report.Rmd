...
endDate <- ymd_hms("2020-04-01 23:00:00")
...
ggplot() +
  ...
  scale_x_datetime(breaks = seq(as.POSIXct("2018-01-01"),
                 as.POSIXct("2020-04-01"), "4 months"), date_labels = "%b %Y",expand = c(0, 0)) +
...
ggplot() +
  ...
  scale_x_datetime(breaks = seq(as.POSIXct("2018-01-01"),
                 as.POSIXct("2020-04-01"), "2 months"), date_labels = "%b %Y",expand = c(0, 0)) +
