...
wq<-wq %>% 
  filter(Obs_Date > "2020-09-01 00:00:00" & Obs_Date < "2021-01-10 23:00:00")
...
startDate <- ymd_hms("2020-09-01 00:00:00")
endDate <- ymd_hms("2021-01-10 23:00:00")
...
ggplot() +
  ...
  scale_x_datetime(breaks = seq(as.POSIXct("2020-09-01"),
                 as.POSIXct("2021-01-10"), "1 month"), date_labels = "%b %Y",expand = c(0, 0)) +
